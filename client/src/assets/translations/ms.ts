export const ms = {
  translation: {
    home: {
      ...
      recipes: "Resipi",
      search: "Cari",
      showMy: "Tunjukkan resipi saya sahaja",
      showAll: "Tunjukkan semua resipi"
    },
    navbar: {
      home: "Utama",
    ...
    form: {
      ...
      create: "Cipta",
      recipe: " Resipi",
      recipeInfo: "Maklumat Resipi",
      recipeName: "Nama Resipi",
      chinName: "Nama Cina",
      cuisine: "Masakan",
      prepTime: "Masa Persediaan",
      ...
      step: "Langkah",
      add: "Tambah ",
      oneIngredient: "Sekurang-kurangnya satu Bahan diperlukan",
      oneStep: "Sekurang-kurangnya satu Langkah diperlukan",
      submit: "Hantar",
      update: "Kemaskini"
    },
    display: {
