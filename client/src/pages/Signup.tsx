        ...
        <div className={`col-md-${step === 1 ? '6' : '9'} d-flex flex-column justify-content-center align-items-center`}>
          ...
          <form style={{minWidth: '330px'}} onSubmit={validateForm}>
            ...
            <div className="form-floating mb-3 position-relative">
              <input type={isPassword ? "text" : "password"} className="form-control" id="password" placeholder="Password" onChange={e => setPassword(e.target.value)} onKeyDown={preventSpaces} maxLength={60} required/>
